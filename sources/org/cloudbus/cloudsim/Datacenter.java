 ...
 * Simulation of Clouds Licence: GPL - http://www.gnu.org/copyleft/gpl.html Copyright (c) 2009-2012,
...
public class Datacenter extends SimEntity {
	...
	protected boolean contains(String fileName) {
		...
		Iterator<? extends Storage> it = getStorageList().iterator(); // Type changed by Baptiste
																		// Louis
