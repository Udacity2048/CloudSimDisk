 ...
 * Licence: GPL - http://www.gnu.org/copyleft/gpl.html Copyright (c) 2009-2012, The University of Melbourne, Australia
 */
...
public class SimEvent implements Cloneable, Comparable<SimEvent> {
	...
	/**
	 * Convert the SimEvent to String and add it to Log File.
	 * 
